...
//       <a href="https://github.com/Bhanuprasad0079" target="_blank" rel="noreferrer">
//         VibeCoded by Bhanu Prasad Khuntia
//       </a>
//       {/* <div className="gh-stats">
//         <span><FaStar /> 8,279</span>
//         <span><FaCodeBranch /> 4,214</span>
//       </div> */}
//     </footer>
//   );
// }
  ...
  return (
    <footer className="footer">
      ...
      <ul className="footer-socials">
        {socials.map((s, i) => (
          <li key={i}>
            <a href={s.href} target="_blank" rel="noreferrer" aria-label="Social link">
              {s.icon}
            </a>
          </li>
        ))}
